...
from cleverhans_tutorials.tutorial_models import make_basic_cnn,make_compare_cnn
...
def mnist_tutorial(train_start=0, train_end=60000, test_start=0,
    ...
    preds1 = model1.get_probs(x1)
    fgsm1 = FastGradientMethod(model1, sess=sess)
    ...
    if clean_train:
        ...
        def fgsm_combo():
            ...
            acc = model_eval(sess, x1, y1, preds_adv1, X_test, Y_test, args=eval_par)                          
            print("Test accuracy on AE from other model by fgsm %0.4f\n"%acc)
